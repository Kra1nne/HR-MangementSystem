                ...
                <div class="col">
                    <ul class="timeline mb-0">
                        ...
                        <li class="timeline-item timeline-item-transparent">
                            ...
                            <div class="timeline-event">
                                <div class="timeline-header mb-3">
                                    <h6 class="mb-0">Resume Screening</h6>
                                </div>
                                <p class="mb-2">HR reviews the submitted resumes and shortlists qualified applicants.</p>
                            </div>
                        </li>
                        ...
                        <li class="timeline-item timeline-item-transparent">
                            ...
                            <div class="timeline-event">
                                <div class="timeline-header mb-3">
                                    <h6 class="mb-0">HR Interview</h6>
                                </div>
                                <p class="mb-2">Initial interview with HR to discuss background, experience, and
                                    expectations.</p>
                            </div>
                        </li>
                        ...
                        <li class="timeline-item timeline-item-transparent">
                            ...
                            <div class="timeline-event">
                                <div class="timeline-header mb-3">
                                    <h6 class="mb-0">Assessment or Exam</h6>
                                </div>
                                <p class="mb-2">Applicant completes a skills test or assessment related to the job role.
                                </p>
                            </div>
                        </li>
                        ...
                        <li class="timeline-item timeline-item-transparent">
                            ...
                            <div class="timeline-event">
                                <div class="timeline-header mb-3">
                                    <h6 class="mb-0">Manager Interview</h6>
                                </div>
                                <p class="mb-2">Department manager evaluates the applicant's technical skills and
                                    experience.</p>
                            </div>
                        </li>
                        ...
                        <li class="timeline-item timeline-item-transparent">
                            ...
                            <div class="timeline-event">
                                <div class="timeline-header mb-3">
                                    <h6 class="mb-0">Final Interview</h6>
                                </div>
                                <p class="mb-2">Final discussion with senior management before the hiring decision.</p>
                            </div>
                        </li>
