    ...
    <div class="email-wrapper">
        ...
        <div class="email-header">
            ...
            <div class="header-tagline">
                ...
                <p>Kindly review the information provided below</p>
            </div>
        </div>
        ...
        <div class="email-body">
            ...
            <p style="margin-top:10px;">
                Our team is currently reviewing your application submitted using the email
                <strong>{{ $email }}</strong>.
            </p>

            <p style="margin-top:10px;">
                Please wait for further instructions regarding the next steps of the recruitment process.
            </p>
